...
class ExampleAppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(
        ...
        AELog("=== AppDelegate: Application Starting ===\n")
        ...
        AELog("Total registered modules: \(AEModuleCenter.shared.moduleCount)\n")
    ...
    private func registerModules() {
        ...
        for module in modules {
            ...
            if success {
                AELog("✅ Registered: \(type(of: module))")
            } else {
                AELog("❌ Failed to register: \(type(of: module))")
            }
        }
    ...
    func addNewModule() {
        ...
        AELog(success ? "✅ Dynamic module added" : "❌ Failed to add dynamic module")
    }

    /// 移除模块的示例
    func removeModule() {
        let success = AEModuleCenter.shared.unregister(module: customModule)
        AELog(success ? "✅ Module removed" : "❌ Failed to remove module")
        AELog("Remaining modules: \(AEModuleCenter.shared.moduleCount)")
    }
}
